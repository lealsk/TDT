...
package net.hires.debug {
	...
	public class Stats extends Sprite {	
		...
		protected var unit_count : int;
		protected var time_counter : int;
		...
		public function Stats() : void {
			...
			style.setStyle('unitcount', {color: hex2css(colors.unitcount)});
			style.setStyle('timecounter', {color: hex2css(colors.timecounter)});
			...
			rectangle = new Rectangle(WIDTH - 1, 0, 1, HEIGHT - 70);			
		...
		private function init(e : Event) : void {
			...
			graph = new BitmapData(WIDTH, HEIGHT - 70, false, colors.bg);
			graphics.beginBitmapFill(graph, new Matrix(1, 0, 0, 1, 0, 70));
			graphics.drawRect(0, 70, WIDTH, HEIGHT - 70);
		...
		private function update(e : Event) : void {
			...
			if( timer - 1000 > ms_prev ) {
				...
				time_counter++;
				unit_count = UnitManager.instance.units.length;
				
				xml.fps = "FPS: " + fps + " / " + stage.frameRate; 
				xml.mem = "MEM: " + mem;
				xml.memMax = "MAX: " + mem_max;
				xml.unitcount = "UNITS: " + unit_count;	
				xml.timecounter = "TIME: " + time_counter;		
...
class Colors {
	...
	public var unitcount : uint = 0xffffff;
	public var timecounter : uint = 0xAAAAAA;
